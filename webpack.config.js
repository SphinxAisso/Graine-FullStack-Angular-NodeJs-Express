...
module.exports = function makeWebpackConfig() {
    ...
    config.output = isTest ? {} : {
        ...
        publicPath   : isProd ? '/' : 'http://localhost:8001/',
    ...
    if (isProd) {
        atlOptions = 'inlineSourceMap=false&sourceMap=false';
    }
    ...
    config.module = {
        rules: [
            ...
            // all css in src/client/style will be bundled in an external css file
            {
                test   : /\.css$/,
            ...
            // all css required in src/client/app files will be merged in js files
    ...
    if (isProd) {
        config.plugins.push(
            ...
            //     {from: root('src/client/public'), to: root('dist/public')}
            //     // {from: root('src/server'), to: root('dist')}
            //     ])

            new CopyWebpackPlugin([{
                from: root('src/client/public')
            }], {ignore: ['fonts/**/*.*', 'img/**/*i.png', 'img/**/*c.png', 'img/**/*e.png']})
        );
    }
